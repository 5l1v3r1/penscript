...
def argSet(parser):
    ...
    parser.add_argument("-O", "--out",type=str, help="output file e.g res.txt", default="res.xlsx")
    parser.add_argument("-S", "--search",type=str, help="search key in title or content,e.g. 管理,后台", default=None)
    parser.add_argument("-N", "--threadnum",type=int, help="Thread Num e.g. 10", default=100)
    return parser
